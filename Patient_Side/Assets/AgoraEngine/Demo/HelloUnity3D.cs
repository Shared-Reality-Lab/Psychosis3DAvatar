...
public class HelloUnity3D : MonoBehaviour
{
    ...
    // After you entered the App ID, remove ## outside of Your App ID//app_id
    [SerializeField]
    private string AppID = "3d084f6ff5474716807e8af45d6ad596";
    ...
    {
        string channelName ="channel1";// mChannelNameInputField.text.Trim();
