...
public class Client : MonoBehaviour
{
	...
	[Header("Network")]
	public string ipAdress = "127.0.0.1";//127.0.0.1//192.168.17.1//142.157.254.106//10.121.126.106
	public int port = 5000;//54010
	...
	protected void StartClient()
	{
		...
		try
		{
			...
			m_Client.Connect(ipAdress, port);//ipAdress
	...
	protected virtual void OnMessageReceived(string receivedMessage)
	{
		...
		switch (receivedMessage)
		{
			...
			default:
				...
				PlayerPrefs.SetString("Clientreceive", receivedMessage);
				break;
		}
	}
