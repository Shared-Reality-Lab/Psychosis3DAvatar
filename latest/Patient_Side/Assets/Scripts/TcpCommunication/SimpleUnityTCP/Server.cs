...
public class Server : MonoBehaviour
{
	...
	[Header("Network")]
	public string ipAdress = "127.0.0.1";//132.206.74.93// //132.206.74.93
	...
	public NetworkStream m_NetStream = null;
	...
	{
		PlayerPrefs.SetString("Serverreceive", "initialize");
		try
		{
			//Set and enable Server 
			
			IPAddress ip = IPAddress.Parse(ipAdress);
			m_Server = new TcpListener(IPAddress.Any, port);//ip
	...
	protected virtual void OnMessageReceived(string receivedMessage)
	{
		...
		switch (receivedMessage)
		{
			...
			default:
				...
				PlayerPrefs.SetString("Serverreceive", receivedMessage);
				break;
		}
	}
