...
public class AT_the_Pause : MonoBehaviour
{
    ...
    public bool SetupSocket()
    {
        try
        {
            mySocket.Connect(IPAddress.Any, Port);//Host
    ...
    void SendWav()
    {
        ...
        string Sendfilename = @"F:/SRL/128.wav";
